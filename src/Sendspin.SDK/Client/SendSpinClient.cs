        ...
        switch (type)
        {
            ...
            case MessageTypes.ManagementSetPairingConfig:
            {
                ...
                if (payload.TryGetProperty("dynamic_pin", out var dp))
                {
                    ...
                    {
                        requestedDynamicPinEnabled = ReadBool(dpEnabled, "dynamic_pin.enabled");
                    }
                ...
                if (payload.TryGetProperty("static_pin", out var sp))
                {
                    ...
                    {
                        string pin = ReadString(pinEl, "static_pin.pin");
                    ...
                    {
                        requestedStaticPinEnabled = ReadBool(spEnabled, "static_pin.enabled");
                    }
