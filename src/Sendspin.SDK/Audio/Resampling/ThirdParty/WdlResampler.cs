...
// ─────────────────────────────────────────────────────────────────────────────
// ALTERED SOURCE VERSION — vendored into Sendspin.SDK on 2026-08-25 from
// https://github.com/naudio/NAudio (NAudio.Core/Dsp/WdlResampler.cs, MIT).
// This is not the original NAudio distribution. The alterations, in full:
//   1. namespace NAudio.Dsp -> Sendspin.SDK.Audio.Resampling.ThirdParty
//   2. `public class WdlResampler` -> `internal class WdlResampler`
//      (the SDK does not re-export third-party types)
//   3. added `#nullable disable` and the analyzer suppressions below, because
//      the SDK compiles with nullable reference types and StyleCop enabled
// The resampling algorithm itself is untouched. Do not "clean up" this file:
// keeping it diffable against upstream is worth more than house style. See
...
#pragma warning disable SA1303 // Constant names should begin with upper-case letter
#pragma warning disable SA1306 // Field names should begin with lower-case letter
#pragma warning disable SA1307 // Accessible fields should begin with upper-case letter
#pragma warning disable SA1308 // Field names should not begin with the prefix 'm_'
...
#pragma warning disable S2325 // Methods that do not access instance data should be static
#pragma warning disable S1066 // Merge collapsible if statements
#pragma warning disable S1116 // Remove empty statement
...
namespace Sendspin.SDK.Audio.Resampling.ThirdParty
{
    /// <summary>
