...
/// </summary>
/// <remarks>
/// Internal on the 9.x line: the published surface is frozen, so the derivation is applied
/// from inside <see cref="Sendspin.SDK.Client.ClientCapabilities"/> rather than offered as a
/// new type for callers to drive.
/// </remarks>
/// <remarks>
/// <para>
...
/// </para>
/// </remarks>
internal static class PlayerBufferCapacity
{
    /// <summary>
    ...
    /// ahead.
    /// </remarks>
    internal const int DefaultDecodedBufferMilliseconds = 30_000;
    ...
    /// </summary>
    internal const int AdvertisedFractionDenominator = 5;
    ...
    internal static int CompressedBytesPerSecond(AudioFormat format)
    {
    ...
    /// </exception>
    internal static int AdvertisedBytes(int decodedBufferMilliseconds, IEnumerable<AudioFormat> formats)
    {
    ...
    /// <exception cref="ArgumentNullException">Thrown when <paramref name="format"/> is null.</exception>
    internal static double HoldableMilliseconds(long advertisedBytes, AudioFormat format)
    {
