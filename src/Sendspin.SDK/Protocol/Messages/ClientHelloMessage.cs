...
public sealed class PlayerSupport
{
    ...
    /// </summary>
    /// <remarks>
    /// <c>SendSpinClient</c> always populates this from <c>ClientCapabilities.BufferCapacity</c>,
    /// which derives it from the real decoded-buffer duration. The default here only applies to
    /// a <see cref="PlayerSupport"/> built by hand, and matches the SDK's default buffer; see
    /// <see cref="Sendspin.SDK.Audio.PlayerBufferCapacity"/>.
    /// </remarks>
